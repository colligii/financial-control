<script lang="ts">
type DataReturn = { timeout: number | null, show: boolean };
...
<template>
    <div v-show="show"
        class="bg-red-500 text-white p-2 rounded absolute left-1/2 top-4 -translate-x-1/2 flex items-center gap-2 z-20">
